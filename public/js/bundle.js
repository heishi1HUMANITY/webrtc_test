...
var textToReceiveSdp = document.querySelector('#receiveSdp');
var resiveRemoteButton = document.querySelector('#receiveRemoteSdp');
var textForSendSdp = document.querySelector('#sendSdp');
var localStream = null;
var peerConnection = null;
var negotiationneededCounter = 0;
var isOffer = false;
var prepareNewConnection = function (isOffer) {
    ...
    peer.onnegotiationneeded = function () { return __awaiter(void 0, void 0, void 0, function () {
        var offer, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    if (!isOffer) return [3 /*break*/, 3];
                ...
                case 4:
                    err_1 = _a.sent();
                    console.error("setLocalDescription(offer) ERROR: " + err_1);
                    return [3 /*break*/, 5];
...
var playVideo = function (element, stream) {
    element.srcObject = stream;
    element.play()
        .catch(function (err) { return console.error(err); });
};
var sendSdp = function (sessionDescription) {
    console.log('---send sdp---');
    textForSendSdp.value = sessionDescription.sdp;
};
var makeAnswer = function () { return __awaiter(void 0, void 0, void 0, function () {
    var answer, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
resiveRemoteButton.addEventListener('click', function () {
    var text = textToReceiveSdp.value.replace(/\n|\r\n|\r/g, '');
    if (peerConnection) {
...
var setOffer = function (sessionDescription) { return __awaiter(void 0, void 0, void 0, function () {
    var err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, peerConnection.setRemoteDescription(sessionDescription)];
            case 2:
                _a.sent();
            ...
            case 3:
                err_3 = _a.sent();
                console.error("setRemoteDescription(offer) ERROR: " + err_3);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
}); };
var setAnswer = function (sessionDescription) { return __awaiter(void 0, void 0, void 0, function () {
    var err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 3:
                err_4 = _a.sent();
                console.error("setRemoteDescription(answer) ERROR: " + err_4);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
